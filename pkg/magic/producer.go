...
import (
	...
	"github.com/hamza-farouk/go2rtc/pkg/flv"
	"github.com/hamza-farouk/go2rtc/pkg/h264/annexb"
	"github.com/hamza-farouk/go2rtc/pkg/magic/bitstream"
	"github.com/hamza-farouk/go2rtc/pkg/magic/mjpeg"
	"github.com/hamza-farouk/go2rtc/pkg/mpegts"
	"github.com/hamza-farouk/go2rtc/pkg/mpjpeg"
	"github.com/hamza-farouk/go2rtc/pkg/wav"
	"github.com/hamza-farouk/go2rtc/pkg/y4m"
)
...
func Open(r io.Reader) (core.Producer, error) {
	...
	// https://github.com/hamza-farouk/go2rtc/issues/747
