...
var stackSkip = [][]byte{
	...
	// api/stack.go
	[]byte("github.com/hamza-farouk/go2rtc/internal/api.stackHandler"),

	// api/api.go
	[]byte("created by github.com/hamza-farouk/go2rtc/internal/api.Init"),
	[]byte("created by net/http.(*connReader).startBackgroundRead"),
	[]byte("created by net/http.(*Server).Serve"), // TODO: why two?

	[]byte("created by github.com/hamza-farouk/go2rtc/internal/rtsp.Init"),
	[]byte("created by github.com/hamza-farouk/go2rtc/internal/srtp.Init"),

	// homekit
	[]byte("created by github.com/hamza-farouk/go2rtc/internal/homekit.Init"),
